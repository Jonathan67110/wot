...
-- Creation de la base
-- -----------------------------------------------------------
CREATE DATABASE wot CHARACTER SET 'utf8';  
-- -----------------------------------------------------------
...
LOAD DATA LOCAL INFILE 'C://Users//Esekios2//SQL//Canon.csv'
INTO TABLE Canon
...
LOAD DATA LOCAL INFILE 'C://Users//Esekios2//SQL//Moteur.csv'
INTO TABLE Moteur
FIELDS TERMINATED BY ';'
ESCAPED BY ':'
LINES TERMINATED BY '\n' -- ou '\r\n' selon l'ordinateur et le programme utilisés pour créer le fichier
...
LOAD DATA LOCAL INFILE 'C://Users//Esekios2//SQL//Tank.csv'
INTO TABLE Tank
FIELDS TERMINATED BY ';'
ESCAPED BY ':'
LINES TERMINATED BY '\n' -- ou '\r\n' selon l'ordinateur et le programme utilisés pour créer le fichier
...
SOURCE 'C://Users//Esekios2//SQL//Table_liaison_tank_canon.sql';
SOURCE 'C://Users//Esekios2//SQL//Table_liaison_tank_moteur.sql';